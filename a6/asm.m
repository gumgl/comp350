function numI = asm(f,a,b,epsilon,level,level_max,fa,fb,fc)
% Function integration using the Adaptive Simpson's Method
%   input:
...
elseif abs(I2-I1) <= 15*epsilon
    ...
    numI = asm(f,a,c,epsilon/2,level,level_max,fa,fc,fd) + asm(f,c,b,epsilon/2,level,level_max,fc,fb,fe);
end
